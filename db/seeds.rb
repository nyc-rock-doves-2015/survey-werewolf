...
10.times do
  ...
  5.times do
    surveytest = usertest.surveys.create(title: Faker::Commerce.department, image: open("https://raw.githubusercontent.com/thoughtbot/refills/master/source/images/mountains.png"))
    4.times do
